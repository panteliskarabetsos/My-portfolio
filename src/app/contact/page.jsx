...
export default function Contact() {
  ...
  const validate = () => {
    ...
    if (!form.message.trim())
      next.message = "Write a short message so I know how I can help.";
  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-background text-foreground">
      ...
      {/* Content */}
      <section className="relative z-10 mx-auto w-full max-w-3xl px-6 pb-20 pt-32 md:px-8 md:pt-40">
        {/* Heading */}
        <motion.div {...fadeUp} className="text-center space-y-4">
          ...
          <h1 className="bg-gradient-to-r from-pink-500 via-purple-400 to-indigo-500 bg-clip-text text-4xl font-extrabold tracking-tight text-transparent md:text-5xl">
            Tell me a bit about your project.
          </h1>

          <p className="mx-auto mt-1 max-w-xl text-sm sm:text-base text-muted-foreground">
            Whether you&apos;re planning a new site, improving an existing one
            or just exploring options, a short message is enough to start the
            conversation.
          </p>
        ...
        <motion.div
          ...
          className="mt-10 rounded-3xl border border-zinc-200/70 dark:border-zinc-800/80 bg-white/85 dark:bg-zinc-950/80 backdrop-blur-2xl p-6 sm:p-7 shadow-[0_18px_45px_rgba(15,23,42,0.35)]"
        >
          <motion.form
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Share what you’re working on, your goals, any links and timelines…"
                className="w-full rounded-lg border border-zinc-300 bg-zinc-100 px-4 py-3 text-zinc-800 outline-none transition focus:border-indigo-300 focus:ring-4 focus:ring-indigo-300/30 dark:border-white/20 dark:bg-white/10 dark:text-white"
              />
              {errors.message && (
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <p className="text-center text-[11px] italic text-muted-foreground sm:text-left">
                By clicking “Send message”, you agree that I can contact you
                about this inquiry.{" "}
                <a
                  href="/legal"
              ...
              {status === "error" && (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="text-xl">❌</span>
                    <span>
                      Something went wrong. Please try again in a moment or use
                      the direct email below.
                    </span>
                  </div>
                </motion.div>
              )}
              {status === "spam" && (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span>
                      This looks like an automated submission. If this is a
                      mistake, feel free to email me directly.
                    </span>
                  </div>
                </motion.div>
              )}
        ...
        <motion.div
          ...
          className="mt-10 flex flex-col items-center justify-center gap-3 text-sm text-muted-foreground sm:flex-row"
        >
        ...
        <motion.div
          ...
          className="mt-8 flex justify-center gap-6 text-zinc-500 dark:text-zinc-400 sm:gap-8"
        >
          {[
            {
